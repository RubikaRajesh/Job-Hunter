...
import { setUser } from "../../store/authSlice"; // import action
...
function Signup() {
  ...
  const postUserData = async (data) => {
    ...
    const backendRole = userType === "employer" ? "employer" : "seeker";

    const userData = {
      email,
      password,
      role: backendRole,
      // Include profile data – adjust based on your backend expectations
    ...
    try {
      // Signup – this sets the cookie automatically
      await userService.signup(userData);

      // Fetch the current user to get full profile
      ...
      if (currentUser) {
        ...
        // Navigate to onboarding (single route)
        navigate("/onboarding");
      }
    } catch (error) {
