...
function JobPosting() {
  ...
  const [formData, setFormData] = useState({
    title: "",
    description: "No discription,if needed add it",
    responsibilities: [],
    requirements: [],
    skills: [],
    education: "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Error posting job:", error); // Log the full error object for more details
      setDialog({
        isOpen: true,
        ...
        <div className="p-5">
          <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <InputField
                label="skills"
                description="Enter the needed skills"
                isRequired={true}
